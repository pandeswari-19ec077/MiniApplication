...
public class Atm{
    ...
    static String ATMBank = "City Bank";
    ...
    public static void trueUser(){
        ...
        System.out.println("3. Balance Amt");
    ...
    public static void miniStatement(){
        ...
        u[0]=new UserDetails("ram", 1234, 13000.00,"rs123","1234568",""<"RBI",0,0);
        u[1]=new UserDetails("sharu", 4321, 15000.00,"ra123","1234565","","RBI",0,0);
        u[2]=new UserDetails("sakthi", 1423, 14500.00,"rb123","1234563","","SBI",0,0);
        u[3]=new UserDetails("sindhu", 3241, 11500.00,"rb123","1234561","","SBI",0,0);
        u[4]=new UserDetails("jaanu", 2314, 15700.00,"ra123","1234569","","RBI",0,0);
    }
